...
public class SplashScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(texto, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 350, -1));

        progreso.setForeground(new java.awt.Color(255, 204, 0));
        getContentPane().add(progreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, 350, 20));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/principal/slogan.jpg"))); // NOI18N
        jLabel1.setCursor(new java.awt.Cursor(java.awt.Cursor.WAIT_CURSOR));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 50, 220, 310));
